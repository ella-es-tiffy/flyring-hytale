...
public class DebugEventListener {
    ...
    private void onInteract(PlayerInteractEvent event) {
        Log.info(plugin, "[DEBUG] PlayerInteractEvent: " + event.getPlayer().getPlayerRef().getUsername() +
                " Action: " + event.getActionType());
    }

    private void onMouse(PlayerMouseButtonEvent event) {
        Log.info(plugin, "[DEBUG] PlayerMouseButtonEvent: " + event.getPlayer().getPlayerRef().getUsername() +
                " Data: " + event.getMouseButton());
    }

    private void onReady(PlayerReadyEvent event) {
        Log.info(plugin, "[DEBUG] PlayerReadyEvent: " + event.getPlayer().getPlayerRef().getUsername());
    }
